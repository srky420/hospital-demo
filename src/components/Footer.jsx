    ...
    return (
        <footer class="bg-gray-50">
            <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                ...
                <div>
                    <div class="flex gap-4 items-center text-xl text-teal-600 font-bold">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        ...
                        <li>
                        <a href="#" class="text-gray-700 transition hover:opacity-75"> Hospital Review </a>
                        </li>

                        <li>
                        <a href="#" class="text-gray-700 transition hover:opacity-75"> Annual Reports </a>
                        </li>
                ...
                <p class="text-xs text-gray-500">&copy; 2024. Hospital. All rights reserved.</p>
            </div>
            </footer>
    )
}